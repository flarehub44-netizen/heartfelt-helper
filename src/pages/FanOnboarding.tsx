      ...
      <div className="relative w-full max-w-lg px-6 flex flex-col items-center gap-8">
        ...
        <div className="glass-card w-full rounded-2xl p-8 flex flex-col gap-6">
          ...
          {step === 0 ? (
            ...
            <>
              <div className="text-center">
                <h1 className="font-display text-xl font-bold text-foreground">Criadores sugeridos</h1>
                <p className="text-sm text-muted-foreground mt-1">Siga quem te interessa para montar seu feed</p>
              </div>
              ...
              <div className="flex flex-col gap-2 max-h-80 overflow-y-auto">
                {isLoading ? (
                  ...
                  <p className="text-sm text-muted-foreground text-center py-6">Nenhum criador encontrado</p>
                ) : (
                  suggestedCreators.map((c) => (
                    <FollowableCreator key={c.id} creator={c} />
                  ))
                )}
              </div>
